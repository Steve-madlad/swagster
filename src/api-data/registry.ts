      ...
      resources: [
        {
          ...
          endpoints: [
            ...
            },
            {
              ...
              responseSample: {
                success: true,
                message: 'Game found and joined successfully',
                data: {
                  _meta: {
                    maxPlayers: 4,
                    totalPlayers: 2,
                  },
                  createdAt: 1780488767541,
                  deck: {
                    cards: [
                      'KC',
                      'AD',
                  ...
                  id: 'tbl-OuCOcVpmNEDKLK45EjN',
                  players: {
                    OoAQs74ssjhshMLS5toJYDjRzCw1: {
                      avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Skrillex',
                      chips: 1000,
                      customBet: 0,
                      id: 'OoAQs74ssjhshMLS5toJYDjRzCw1',
                      isConnected: true,
                      isEliminated: false,
                      name: 'Skrillex',
                      seatPosition: 0,
                    ...
                    SwpqCriDXqXAqR2d4SezR5cb6B53: {
                      avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Skrillex',
                      chips: 1000,
                      customBet: 0,
                      id: 'SwpqCriDXqXAqR2d4SezR5cb6B53',
                      isConnected: true,
                      isEliminated: false,
                      name: 'Blazer',
                      seatPosition: 1,
            ...
            },
            {
              ...
              responseSample: {
                ...
                data: {
                  ...
                  gameName: 'Specific Skrill Game',
                  gameState: {
                    eliminatedPlayers: '',
                    potValue: 0,
                    winner: '',
                  },
                  id: 'tbl-OuCTL94P0E4pP4ealKP',
                  players: {
                    OoAQs74ssjhshMLS5toJYDjRzCw1: {
                      avatar: 'https://api.dicebear.com/7.x/adventurer/svg?seed=Skrillex',
                      chips: 1000,
